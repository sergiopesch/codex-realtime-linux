...
- Realtime tool-call arguments, transcript text, event records, and function outputs are bounded before they update the UI or travel back over the Realtime data channel.
