...
- Live transcript panel for the current Realtime session, with transcript lines saved back into the selected conversation so reopening the thread can show the last voice exchange.
