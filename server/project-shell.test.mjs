...
test('artifact previews are served through workspace-scoped routes only', async () => {
  ...
  assert.match(appSource, /const dismissedWorkspacePath = dismissedArtifact\?\.workspacePath \?\? ''/)
  assert.match(appSource, /const matchesDismissedWorkspace = artifact\.workspacePath === dismissedWorkspacePath/)
  assert.match(appSource, /matchesDismissedWorkspace && artifact\.url === dismissedArtifact\?\.url/)
  assert.match(appSource, /matchesDismissedWorkspace && dismissedTime != null/)
  assert.match(appSource, /workspacePath: artifactPreview\.workspacePath/)
  assert.match(appSource, /const artifactTime = finiteTimestamp\(artifact\.updatedAt\)/)
  assert.match(appSource, /artifactTime != null && artifactTime > dismissedTime/)
