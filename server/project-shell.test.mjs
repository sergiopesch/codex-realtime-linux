...
test('persisted workspaces and conversations require absolute workspace paths', async () => {
  ...
  assert.match(serverSource, /if \(normalizedConversations\.length > 0\) \{\s+state\.conversationsByWorkspace\[normalizedWorkspacePath\] = normalizedConversations\s+\}/)
